namespace Problem707 {
  class LinkedListNode {
    constructor(public val: number, public next?: LinkedListNode, public prev?: LinkedListNode) {}
  }
  ...
  class LinkedList {
    ...
    addAtHead(val: number): void {
      ...
      const newItem = new LinkedListNode(val, this.head);
    ...
    addAtTail(val: number): void {
      ...
      const newItem = new LinkedListNode(val, undefined, this.tail);
    ...
    addAtIndex(index: number, val: number): void {
      ...
      before.next = new LinkedListNode(val, next, before);
    ...
    private findNth(index: number): LinkedListNode | undefined {
      let head = this.head;
    ...
    private createHead(val: number): void {
      const newItem = new LinkedListNode(val);
